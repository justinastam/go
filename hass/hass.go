...
//func GetSensorHistory(sensorId string, ts time.Time) [][]SensorState {
//	fmt.Println(ts)
//	var url = getBaseUrl() + "api/history/period/" + ts.Format("2006-01-02T15:04:05-07:00") + "?filter_entity_id=" + sensorId
//
//	resp := doRequest(url)
//
//	defer resp.Body.Close()
